...
const REASONING_EFFORT_OPTIONS: Array<{ value: '' | ReasoningEffortLevel; label: string; short: string; hint: string }> = [
  ...
  { value: 'xhigh', label: 'X-High', short: 'X-High', hint: 'Extended Codex reasoning' },
  { value: 'max', label: 'Max', short: 'Max', hint: 'Maximum Codex reasoning' },
  { value: 'ultra', label: 'Ultra', short: 'Ultra', hint: 'Highest advertised Codex effort' },
]
