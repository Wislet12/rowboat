...
export const BackgroundTaskSchema = z.object({
    ...
    effort: z.enum(['low', 'medium', 'high', 'xhigh', 'max', 'ultra']).optional().describe('ADVANCED — leave unset. Reasoning effort paired with the per-task model override; unset means Auto (provider default). Only meaningful alongside `model`.'),
